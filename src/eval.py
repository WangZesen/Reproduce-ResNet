...
from src.conf import parse_config_from_eval_dir, Config
...
@torch.no_grad()
def valid(cfg: Config, model: Any, valid_ds: DALIGenericIterator, criterion: Module) -> Tuple[float, float, float, int]:
    model.eval()
    total_loss = 0.0
    total_acc1 = 0.0
    total_acc5 = 0.0
